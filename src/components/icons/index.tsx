...
export const UserPlusIcon = ({
  ...
  return (
    ...
    >
      ...
      {/* Corpo (simétrico com a cabeça) */}
      <Path
        d="M5.5 19c0-3.2 3.2-5.5 6.5-5.5s6.5 2.3 6.5 5.5"
        stroke={color}
        strokeWidth={strokeWidth}
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      {/* + (afastado sem afetar o usuário) */}
      <Path
        d="M19 9.5v3.5M20.75 11.25h-3.5"
        stroke={color}
        strokeWidth={strokeWidth}
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const ExcelIcon = ({ size = 24, color = defaultColor }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    />
    <Path
      d="M8 13h2M8 17h2M14 13h2M14 17h2"
      stroke={color}
      strokeWidth={2}
      strokeLinecap="round"
    />
...
export const EyeIcon = ({ size = 24, color = defaultColor }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
export const EyeOffIcon = ({ size = 24, color = defaultColor }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
export const ReceiptIcon = ({ size = 24, color = defaultColor }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
export const CheckCircleIcon = ({ size = 24, color = colors.success }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Circle cx="12" cy="12" r="10" stroke={color} strokeWidth={2} />
    <Path
      d="M9 12l2 2 4-4"
...
export const HistoryIcon = ({ size = 24, color = defaultColor }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M12 8v4l3 3"
      stroke={color}
    ...
    />
    <Path
      d="M3.05 11a9 9 0 1018 0 9 9 0 00-18 0"
      stroke={color}
      strokeWidth={2}
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const AlertTriangleIcon = ({ size = 24, color = colors.warning }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
